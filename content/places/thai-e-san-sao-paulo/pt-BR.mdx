...
O Thai E-San se batiza com o nome de Isaan, e não simplesmente "tailandês" — um detalhe pequeno que já diz algo real sobre o que está no cardápio. Isaan é a região nordeste da Tailândia, culturalmente e gastronomicamente distinta da cozinha tailandesa central, mais associada a Bangkok, que é o que a maioria de quem não é tailandês imagina ao ouvir "comida tailandesa" — mais fermentado e grelhado, arroz glutinoso como base em vez do arroz jasmim, som tam (salada de mamão verde) e larb (salada de carne moída) como pratos âncora em vez do pad thai. Nomear-se pela região é uma promessa específica, não um empréstimo da reputação geral de uma cozinha nacional.
