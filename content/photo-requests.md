...
**do-not-disturb-01-below-the-room (hero) — resolved 2026-09-08, entry removed.**
Built directly as vector-derived work instead of queuing for external
generation: an SVG door-hanger/brass-bell/room-key composition, rasterized
via headless Chrome (local `sharp` install was broken this session). Live
at `public/collections/do-not-disturb-01-below-the-room/hero-illustration.png`,
wired into `meta.json`, issue published across all six locales.
