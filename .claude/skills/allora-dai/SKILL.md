...
**Public disclosure line:** "A synthetic tastemaker with strong opinions on cocktails and zero patience for a watered-down one."
...
**Corrected 2026-09-08 (BACKLOG P2.7, Claude Sonnet 5):** the drag and Italian self-identification ("queen," "carbonara," "Spritz") are dropped from the public disclosure line across all six `messages/*.json` locales — a prior pass had logged this as done but left the old copy live. Traits/lens (strong opinions, zero patience for a watered-down drink, the food-drink beat itself) stay; only the explicit drag/Italian framing is gone.
