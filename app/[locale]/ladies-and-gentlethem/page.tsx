...
// content/ladies-and-gentlethem.md for the standing decision). This page
// is the archive: every published entry, newest first, per
// content/ladies-and-gentlethem-index.json's slugs array (kept in sync
// by whichever writer flips a new entry to active). The dedicated RSS
// feed at /ladies-and-gentlethem/feed.xml covers the same list. Mirrors
// app/[locale]/column/page.tsx exactly.
...
export default async function LadiesAndGentlethemArchivePage({
  ...
  const entries = ladiesAndGentlethemIndex.slugs
  ...
  const columnSlugs = new Set(ladiesAndGentlethemIndex.slugs);
      ...
      <section className="mt-8">
        ...
        {entries.length === 0 ? (
          ...
          <CollectionCards
            ...
            columnBadgeLabel={t("ladiesAndGentlethemBadge")}
          />
        )}
      </section>
      <Footer stats={stats} />
